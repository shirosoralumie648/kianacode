...
| # | 大模块 | 负责什么 | 当前代码锚点与边界 |
|---:|---|---|---|
| 1 | **CompanyOS：组织与业务** | 组织、部门、角色、目标、项目、工单、会议、派发、评审、验收、交付和收尾；回答“谁做什么、怎么算完成” | [领域契约](../kiana-domain/src/lib.rs)、[CO-02 scope bindings](roadmap/company-scope-baseline.md)、[CO-03 assignments](roadmap/assignment-baseline.md)、[CO-04 role catalog](roadmap/role-catalog-baseline.md)、[CO-05 command policy](roadmap/company-policy-baseline.md)、[组织协作](../kiana-core/src/collaboration.rs)、[Company 命令](../kiana-core/src/company.rs)、[跨入口治理投影](../kiana-core/src/company_governance.rs)、[治理产物](../kiana-core/src/artifacts.rs)；业务对象不能绕过 ControlPlane 直接执行副作用 |
