...
| 7 | **Context / Memory：上下文与知识** | 仓库索引、代码地图、检索、记忆读写、记忆治理、访问范围和上下文预算；回答“这次运行应该看到哪些资料” | [CM-01 来源/scope 基线](roadmap/context-scope-baseline.md)、[CM-02 Memory 生命周期](roadmap/memory-lifecycle-baseline.md)、[CM-03 Memory scope](roadmap/memory-scope-baseline.md)、[CM-04 Memory mutation](roadmap/memory-mutation-baseline.md)、[kiana-query](../kiana-query/src/lib.rs)、[Memory 执行](../kiana-daemon/src/harness_memory.rs)、[Memory 检索](../kiana-daemon/src/memory_retrieval.rs)、[压缩](../kiana-runner/src/compact.rs)；索引和记忆是数据消费者，不能取代事实账本 |
