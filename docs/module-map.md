...
| # | 大模块 | 负责什么 | 当前代码锚点与边界 |
|---:|---|---|---|
| 1 | **CompanyOS：组织与业务** | 组织、部门、角色、目标、项目、工单、会议、派发、评审、验收、交付和收尾；回答“谁做什么、怎么算完成” | [领域契约](../kiana-domain/src/lib.rs)、[P1-C-01 Cell contracts](roadmap/cell-contract-baseline.md)、[P1-D-01 ready predicate](roadmap/ready-predicate-baseline.md)、[P1-D-02 dependency graph](roadmap/dependency-graph-baseline.md)、[P1-D-03 lease recovery](roadmap/lease-recovery-baseline.md)、[P3-I-01 Company objects](roadmap/company-object-baseline.md)、[CO-02 scope bindings](roadmap/company-scope-baseline.md)、[CO-03 assignments](roadmap/assignment-baseline.md)、[CO-04 role catalog](roadmap/role-catalog-baseline.md)、[CO-05 command policy](roadmap/company-policy-baseline.md)、[CO-06 artifact/evidence](roadmap/artifact-evidence-baseline.md)、[CO-07 receipts](roadmap/company-receipts-baseline.md)、[CO-08 replay](roadmap/company-replay-baseline.md)、[CO-48 live closeout evidence](roadmap/co48-company-closeout-baseline.md)、[组织协作](../kiana-core/src/collaboration.rs)、[Company 命令](../kiana-core/src/company.rs)、[跨入口治理投影](../kiana-core/src/company_governance.rs)、[治理产物](../kiana-core/src/artifacts.rs)；业务对象不能绕过 ControlPlane 直接执行副作用 |
| 2 | **配置、凭据与身份** | API key、OAuth、模型凭据、配置来源、项目可信度、用户/租户身份、RBAC、角色绑定和密钥轮换 | [P0-K1-01 身份与 authority epoch](roadmap/identity-authority-baseline.md)、[CI-02 identity contracts](roadmap/identity-contracts-baseline.md)、[CI-03 ports](roadmap/ports-identity-baseline.md)、[CI-04 daemon ingress](roadmap/daemon-ingress-baseline.md)、[CI-05 authority ledger](roadmap/authority-ledger-baseline.md)、[CP-01 身份基线](roadmap/control-plane-identity-baseline.md)、[CP-02 执行身份基线](roadmap/control-plane-execution-identity-baseline.md)、[模型配置](../kiana-provider/src/config.rs)、[DaemonHost 身份](../kiana-daemon/src/lib.rs)、[项目可信度与策略](../kiana-policy/src/lib.rs)、[角色目录](../kiana-domain/src/roles.rs)；Provider 只消费已准入的模型路由，不能成为用户身份或项目权限的事实源。当前主要是本地身份和配置边界，租户、OAuth 生命周期、密钥轮换仍需单独验收 |
| 3 | **ControlPlane：控制与授权** | 命令入口、生命周期、ProjectTrust、RBAC/策略、审批、预算、取消、路径锁、能力授权和恢复前检查 | [kiana-core](../kiana-core/src/lib.rs)、[CP-02 Run/Turn/Invocation/Execution](roadmap/control-plane-execution-identity-baseline.md)、[CP-03 action catalog](roadmap/control-plane-action-baseline.md)、[CP-04 ScopeSet](roadmap/control-plane-scope-baseline.md)、[CP-05 入口一致性](roadmap/control-plane-entry-path-baseline.md)、[CP-06 原子转移](roadmap/control-plane-transition-baseline.md)、[Policy](../kiana-policy/src/lib.rs)、[Gates](../kiana-gates/src/lib.rs)；所有有副作用的动作都必须回到这里，不能在 UI、Provider、Connector 或 Workflow 中另起权限判断 |
| 4 | **Harness：Agent 运行时** | 驱动一次 Agent 执行，调用模型、接收工具调用、等待工具结果、继续下一轮、压缩上下文、限制步数并支持受控继续 | [H02 身份基线](roadmap/harness-identity-baseline.md)、[H03 状态驱动器](roadmap/harness-state-driver-baseline.md)、[H04 模型内容基线](roadmap/harness-model-content-baseline.md)、[H05 停止/重试基线](roadmap/harness-stop-retry-baseline.md)、[KianaHarness](../kiana-runner/src/harness.rs)、[Runner 协议](../kiana-runner-protocol/src/lib.rs)、[上下文压缩](../kiana-runner/src/compact.rs)；Harness 只负责规范的单次运行循环，不负责绕过 ControlPlane 执行工具 |
| 5 | **Provider：模型接入** | 模型路由、请求编译、鉴权头、流式响应、工具调用解析、超时、重试分类、能力声明和模型用量回传 | [P4-J7-05 严格响应基线](roadmap/provider-strict-response-baseline.md)、[Provider crate](../kiana-provider/src/lib.rs)、[逐连接 live 证据合同](../kiana-domain/src/provider_live.rs)、[Daemon 模型适配](../kiana-daemon/src/model_client.rs)；Anthropic、OpenAI 兼容、Ollama 等协议属于模型接入，不等于外部业务集成，也不拥有用户或项目身份 |
| 6 | **Capability：工具执行与沙箱** | 将已授权请求分发到 shell、文件补丁、MCP、Memory 等执行器，并落实进程、文件、网络和路径边界 | [P1-H-01 tool authority](roadmap/tool-authority-baseline.md)、[P1-H-03 path containment](roadmap/path-containment-baseline.md)、[CAP-01 authority baseline](roadmap/capability-authority-baseline.md)、[CAP-02 input/digest baseline](roadmap/capability-input-baseline.md)、[CAP-03 ExecutionScope](roadmap/capability-execution-scope-baseline.md)、[CAP-04 state/outcome baseline](roadmap/capability-state-baseline.md)、[Capability Broker](../kiana-capability-broker/src/lib.rs)、[工具适配](../kiana-daemon/src/harness_capabilities.rs)、[沙箱](../kiana-daemon/src/harness_sandbox.rs)、[MCP 适配](../kiana-daemon/src/harness_mcp.rs)；MCP 是工具协议，不是全部集成能力 |
| 7 | **Context / Memory：上下文与知识** | 仓库索引、代码地图、检索、记忆读写、记忆治理、访问范围和上下文预算；回答“这次运行应该看到哪些资料” | [CM-01 来源/scope 基线](roadmap/context-scope-baseline.md)、[CM-02 Memory 生命周期](roadmap/memory-lifecycle-baseline.md)、[CM-03 Memory scope](roadmap/memory-scope-baseline.md)、[CM-04 Memory mutation](roadmap/memory-mutation-baseline.md)、[CM-38 golden-path evidence](../kiana-domain/src/context_memory_evidence.rs)、[CM-39 handoff baseline](roadmap/cm39-context-memory-closeout-baseline.md)、[kiana-query](../kiana-query/src/lib.rs)、[Memory 执行](../kiana-daemon/src/harness_memory.rs)、[Memory 检索](../kiana-daemon/src/memory_retrieval.rs)、[压缩](../kiana-runner/src/compact.rs)；索引和记忆是数据消费者，不能取代事实账本 |
| 8 | **持久化与数据层** | EventLog、ApprovalStore、Memory、索引、工单、收据等对象的 schema、迁移、备份、恢复、保留和存储适配 | [PD-00 基线](roadmap/persistence-data-layer-baseline.md)、[EventStore 接口](../kiana-ports/src/lib.rs)、[事件存储](../kiana-eventlog/src/lib.rs)、[审批存储](../kiana-daemon/src/approval_store.rs)、[Memory 存储](../kiana-eventlog/src/memory.rs)；这里定义数据生命周期和存储边界，不能因为 EventLog 存在就推断已经有完整备份、迁移或保留策略 |
| 9 | **Event / Receipt / Recovery：执行事实与恢复** | 保存执行事实，生成 Receipt，投影运行状态和历史，处理审批恢复、结果未知、重放和恢复前校验 | [P0-G-04 重建证据](../kiana-core/tests/p0_g04_projection_guard.rs)、[ER-01 事件 schema/kind 基线](roadmap/event-receipt-schema-baseline.md)、[ER-02 关联/顺序基线](roadmap/event-receipt-identity-baseline.md)、[ER-03 脱敏/Artifact 基线](roadmap/event-receipt-redaction-baseline.md)、[ER-04 CommandReceipt 基线](roadmap/event-receipt-command-receipt-baseline.md)、[事件投影](../kiana-core/src/projection.rs)、[Invocation 投影](../kiana-core/src/invocation_projection.rs)、[CP-02 执行身份基线](roadmap/control-plane-execution-identity-baseline.md)、[历史](../kiana-core/src/history.rs)、[收据](../kiana-core/src/receipts.rs)、[恢复](../kiana-core/src/recovery.rs)；EventLog 是事实源，但不等价于指标、Trace、审计报表或所有业务数据 |
| 10 | **可观测性与审计** | 结构化 logs、metrics、traces、token/成本观测、健康检查、告警、操作审计和安全调查 | [Runtime 事件](../kiana-core/src/events.rs)、[运行流](../kiana-daemon/src/run_stream.rs)、[domain signal contracts](../kiana-domain/src/observability.rs)、[operator evidence](../kiana-core/src/operator_evidence.rs)、[audit taxonomy/reducer](../kiana-domain/src/audit.rs)、[core audit facade](../kiana-core/src/audit.rs)、[audit projection/checkpoint](../kiana-core/src/audit_projection.rs)、[audit query core/cursor](../kiana-core/src/audit_projection.rs)、[audit export/manifest/delivery](../kiana-core/src/audit_export.rs)、[observability incident/recovery projection](../kiana-core/src/incident_projection.rs)、[replay/reconciliation diagnostics](../kiana-core/src/replay_diagnostics.rs)、[deterministic fault matrix](../kiana-core/src/fault_injection.rs)、[provider-independent eval](../kiana-core/src/eval.rs)、[entrypoint parity projection](../kiana-core/src/parity.rs)、[performance/capacity/migration baseline](../kiana-core/src/performance.rs)、[durable gate and evidence manifest](../scripts/oa26-durable-observability-gate.sh)、[live handoff contract/runbook](../kiana-domain/src/live_handoff.rs)、[data governance/retention projection](../kiana-core/src/data_governance.rs)、[audit/parity wire/client](../kiana-protocol/src/lib.rs)、[span lifecycle projection](../kiana-core/src/span_projection.rs)、[model attempt projection](../kiana-core/src/model_attempt_projection.rs)、[capability attempt projection](../kiana-core/src/capability_attempt_projection.rs)、[operational metrics projection/governance](../kiana-core/src/metrics.rs)、[health/readiness projection](../kiana-core/src/health.rs)、[bounded observability queue](../kiana-ports/src/observability_queue.rs)、[trace export/context adapter](../kiana-core/src/trace_export.rs)、[provider safe telemetry](../kiana-provider/src/telemetry.rs)、[daemon model boundary](../kiana-daemon/src/model_client.rs)、[broker/handler boundary](../kiana-core/src/capabilities.rs)、[ports and fake sinks/observer](../kiana-ports/src/lib.rs)、[EventStore commit observer](../kiana-eventlog/src/stream.rs)、[correlation links](../kiana-domain/src/correlation.rs)、[redaction profiles](../kiana-domain/src/redaction.rs)、[脚本与 CI](../scripts/)、[当前状态证据](../CURRENT_STATUS.md)；EventLog 记录产品事实，不能自动替代指标、分布式追踪、告警或合规审计管线，后者需要独立 schema 和保留边界；OA-00–OA-28 的当前信号归属与缺口见 [Observability/Audit 基线](roadmap/observability-audit-baseline.md)；ER-30 operator evidence 的 source proof 见 [ER-30 baseline](roadmap/er30-observability-baseline.md) |
...
| 13 | **集成与连接器** | GitHub、Jira、Slack、Notion、浏览器、搜索、OAuth、Webhook 以及其他外部系统的账号绑定、限流、映射和失败处理 | [INT-00 基线](roadmap/integrations-baseline.md)、[连接器领域模型](../kiana-domain/src/connectors.rs)、[Daemon 连接器](../kiana-daemon/src/connectors.rs)、[MCP stdio](../kiana-daemon/src/mcp_stdio.rs)；当前源码可核对的实现边界是 `local_fixture`，MCP 只描述部分工具调用通道，连接器还需要凭据、对象映射、幂等和外部结果确认；详细设计、处理流程和 `INT-00`–`INT-33` 见 [连接器专项](roadmap/integrations-connectors.md) |
| 14 | **通知与消息** | 审批、任务、会议、工单变更、失败、提醒和实时协作消息；包含订阅、投递、去重和已读状态 | [运行流订阅](../kiana-daemon/src/run_stream.rs)、[Human Inbox 投影](../kiana-core/src/platform.rs)、[协议事件](../kiana-protocol/src/lib.rs)、[人类操作入口](../kiana-entrypoints/src/workbench_chat.rs)、[P1-E-01 communication](roadmap/communication-baseline.md)、[NM-00 基线](roadmap/notifications-baseline.md)、[通知与消息专项](roadmap.md#notification-messaging-design)；当前主要是运行流、Human Inbox 和入口展示，尚无可以替代业务事件的独立通知总线 |
| 15 | **Skills / Plugins / Hooks：扩展** | 加载技能说明、插件、钩子和本地扩展，在受信任范围内接入运行阶段 | [EXT-01 扩展合同](roadmap/extension-contracts-baseline.md)、[EXT-02 SourceResolver](roadmap/source-resolver-baseline.md)、[EXT-03 严格解析器](roadmap/strict-extension-parsers-baseline.md)、[EXT-04 Catalog](roadmap/catalog-baseline.md)、[EXT-05 Snapshot](roadmap/snapshot-invalidation-baseline.md)、[EXT-29 fake golden](roadmap/ext29-extension-golden-baseline.md)、[EXT-30 recovery](roadmap/ext30-extension-recovery-baseline.md)、[EXT-31 release gate](roadmap/ext31-extension-release-baseline.md)、[Skills](../kiana-skills/src/lib.rs)、[技能注入](../kiana-daemon/src/harness_skills.rs)、[前置钩子](../kiana-daemon/src/pre_tool_hooks.rs)；项目本地资源必须先过 ProjectTrust，扩展不能新增第二条执行路径 |
| 16 | **UI / Entrypoints：用户入口** | CLI、终端工作台、Web、Electron、状态卡、审批卡、对话、文件变化、收据和实时进度展示 | [UI-01 protocol DTO](roadmap/ui-protocol-baseline.md)、[UI-02 handshake](roadmap/ui-handshake-baseline.md)、[UI-03 instance](roadmap/ui-instance-baseline.md)、[UI-40 evidence bundle](roadmap/ui40-release-gate-baseline.md)、[UI-41 handoff](roadmap/ui41-handoff-baseline.md)、[入口注册](../kiana-entrypoints/src/lib.rs)、[CLI](../kiana-entrypoints/src/cli.rs)、[Web](../kiana-entrypoints/src/web.rs)、[Desktop](../contrib/desktop/main.js)；UI 只能投影状态和事件，不能自行创建 Agent loop 或权限边界 |
...
| 19 | **部署、运维与迁移** | 升级、备份、恢复演练、多环境配置、本地/云部署、版本迁移、健康检查和运维工具 | [发布脚本](../scripts/)、[Desktop 壳](../contrib/desktop/)、[container lifecycle evidence](../kiana-domain/src/container_lifecycle_evidence.rs)、[orchestrated rollout evidence](../kiana-domain/src/orchestrated_rollout_evidence.rs)、[schema 版本](../kiana-domain/src/contracts.rs)、[运行配置](../kiana-daemon/src/lib.rs)；本地优先不等于已经具备云部署、多环境迁移或自动备份；实际代码设计、处理流程和 `DEP-*` 实施步骤见 [roadmap §36](roadmap.md#deployment-operations-migration-design) |
| 20 | **安全与合规** | 加密、秘密处理、审计、隐私、数据保留、删除、最小权限、供应链和合规证明 | [SC-00 安全基线](roadmap/security-compliance-baseline.md)、[SC-43 review record](security/sc43-security-review.md)、[SC-43 closeout](roadmap/sc43-security-closeout-baseline.md)、[安全宪法](company-os-security-constitution.md)、[Policy/Gates](../kiana-policy/src/lib.rs)、[脱敏](../kiana-domain/src/redaction.rs)、[数据治理](../kiana-core/src/data_governance.rs)；安全控制分布在执行链中，合规要求仍需独立的策略、证据和生命周期设计；完整的威胁模型、代码边界、处理流和 SC-00–SC-43 实施卡见 [roadmap §37](roadmap.md#security-compliance-plan) 与 [安全与合规专项](roadmap/security-compliance.md) |
...
OA-24 的入口 parity 也遵循这张地图：CLI、Workbench、Web 和 Desktop 只负责调用
`kiana-entrypoints::harness_run`，由协议与 `DaemonHost → ControlPlane` 读取同一个 owner-scoped
`EntryPointParitySnapshot`。健康、Receipt、Audit、retention 和 `result_unknown` 字段均来自提交事实投影；
入口 UI、transcript、SSE、Electron 状态或本地缓存不能自行读 EventLog、拼装成功结论或发起恢复动作。

OA-25 的性能与迁移证据同样不另起事实层：`PerformanceBaseline` 绑定远端 benchmark 的
append/flush/project/rebuild/query/export 摘要、journal/queue/artifact hard limits 和受限 migration observations；
percentile、rotation、archive、upgrade、downgrade 与容量护栏都是可重放的 source artifact，不能覆盖
EventLog、Receipt、Health 或授权，也不能把 CI 时延样本写成生产 SLO。

OA-26 的 durable gate 由 [CI-only evidence script](../scripts/oa26-durable-observability-gate.sh) 负责，
只在 GitHub runner 上写出 artifact hash、重开投影和秘密扫描结果；本地调用会 fail-closed。该脚本维护
`DaemonHost → ControlPlane → EventLog` 的唯一事实链，不把 release smoke、内存队列或单测 mock 当作
durable，也不把单机重开升级成 physical/live 证明。

OA-28 的 live/physical handoff 由 [LiveHandoffManifest](../kiana-domain/src/live_handoff.rs) 和
[opt-in preflight](../scripts/oa28-live-handoff-preflight.sh) 约束：每个 provider、connector、OTLP backend
或 OS 目标都必须有隔离环境、非秘密 SecretRef、独立批准/回执/对账/清理证据；未显式 opt-in 或缺少任一
证据即拒绝。该层只负责交接清单，不能绕过 ControlPlane，也不能把网络 ACK、mock receipt 或 CI 结果写成
live、physical 或业务 Outcome。

AUT-01 的调度基线见 [automation-baseline.md](roadmap/automation-baseline.md)：当前唯一产品
...
PD-00 的数据层基线见 [persistence-data-layer-baseline.md](roadmap/persistence-data-layer-baseline.md)：
EventLog/Transition/Receipt 是唯一事实写入，Projection/Memory/Index/Cache/Notification/UI 是可重建派生层，
Artifact/Approval 各有独立生命周期。Memory adapter、单机 JSONL reopen、CI green 或文件存在都不能替代
StorageRoot/StoreIdentity、backup/migration/retention、owner/data epoch 和跨进程 durable 证据；后续 PD 步骤
必须沿同一 DaemonHost/ControlPlane 和 EventStorePort 增量收敛，禁止双写第二账本。
