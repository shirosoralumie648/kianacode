...
| 3 | **ControlPlane：控制与授权** | 命令入口、生命周期、ProjectTrust、RBAC/策略、审批、预算、取消、路径锁、能力授权和恢复前检查 | [kiana-core](../kiana-core/src/lib.rs)、[CP-02 Run/Turn/Invocation/Execution](roadmap/control-plane-execution-identity-baseline.md)、[Policy](../kiana-policy/src/lib.rs)、[Gates](../kiana-gates/src/lib.rs)；所有有副作用的动作都必须回到这里，不能在 UI、Provider、Connector 或 Workflow 中另起权限判断 |
