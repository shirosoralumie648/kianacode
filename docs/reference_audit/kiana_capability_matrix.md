...
6. MCP dynamic tool/prompt/resource parity
   ...
   - Acceptance: MCP tool discovery, prompt list/get, resource read, isError result and server disconnect all produce stable events.
