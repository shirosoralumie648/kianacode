...
| Tool lifecycle | 已有 registry、tool_execution、runtime events | 所有 public surfaces 的 lifecycle/error 断言还不完整 | `kiana-tools/src/tool_execution.rs`, `kiana-entrypoints/src/runner.rs` | stream-json/TUI/remote lifecycle snapshots | P0 |
