...
| 下一步 | `OA-04` Audit taxonomy / reducer | `OA-01` AuditRecord、`OA-02` causation/attempt links 与 `OA-03` redaction boundary 已固定；下一步从 committed security facts 派生不可伪造的 audit record/reducer | 模型/UI/plugin/exporter 不能伪造批准、完成或导出，原 record 只能追加更正 |
