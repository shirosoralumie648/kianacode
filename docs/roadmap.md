...
| 2026-09-23 | `CM-11` reopened after GitHub run 35837267218 at `107785c4e197f1353661728a14ead8f964aae00a` reported 11 compiler errors in `index_invalidation.rs`: ambiguous `WorkspaceFileSnapshot` plus resulting type/field mismatches. Follow-up explicitly imports the `workspace_snapshot` contract. No local tests/build/check/clippy run; GitHub CI must recompile before CM-11 returns to ✅ | pending |
