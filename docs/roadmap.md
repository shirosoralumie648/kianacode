...
| 下一步 | `OA-05` Observability/Audit ports and fake adapters | `OA-04` taxonomy/reducer 已固定；下一步提供 sink/query/health port、Memory/JSONL fake 以及 flush/capability failure 夹具 | exporter/sink 错误不能授予权限；不支持 durable/flush 的 adapter 被依赖时 fail-closed |
