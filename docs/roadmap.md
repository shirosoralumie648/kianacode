...
| 下一步 | `OA-03` RedactionProfile / bounded signal encoder | `OA-01` schema 与 `OA-02` typed links 已固定；下一步统一 span/log/metric/audit/export 的 classification、secret sentinel、bounded value 与错误 fail-closed | redactor error 不得回退原文，任何 telemetry 失败不能改变事实或授权 |
