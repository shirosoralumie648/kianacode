# AUT-13 Advance planner baseline
...
The AUT-13 source/CI planner slice is complete at this boundary. The planner still returns
intent/effect to ControlPlane; it does not execute a child or capability. Scope/path/budget leases,
durable reservation/worker dispatch and physical child recovery remain AUT-07/AUT-14/AUT-19 work.
Older snapshots default missing output/depth fields conservatively.
