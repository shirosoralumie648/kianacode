# AUT-10 interval cursor baseline
...
The AUT-10 source/CI slice is complete at the pure planner boundary. It does not claim a trusted
wall/monotonic clock adapter, durable cursor checkpoint, timer worker, restart replay or external
trigger effect. Those remain AUT-02, AUT-09 and later workflow/ingress steps; CI owns the behavior
fixtures.
