...
| Skills / Plugins / Hooks | EXT-00–EXT-31（32） | [EXT-01 扩展合同](extension-contracts-baseline.md) · [EXT-02 SourceResolver](source-resolver-baseline.md) · [EXT-03 严格解析器](strict-extension-parsers-baseline.md) · [EXT-04 Catalog](catalog-baseline.md) · [扩展来源、信任与生命周期](skills-plugins-hooks.md) |
