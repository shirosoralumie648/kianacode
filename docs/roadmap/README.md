...
| Capability | CAP-00–CAP-34（35） | [CAP-01 authority 基线](capability-authority-baseline.md) · [CAP-02 input/digest 基线](capability-input-baseline.md) · [CAP-03 ExecutionScope](capability-execution-scope-baseline.md) · [能力目录、Broker 与执行边界](capability.md) |
