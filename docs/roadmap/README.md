...
| CompanyOS | CO-01–CO-48（48） | [CO-02 scope bindings](company-scope-baseline.md) · [CO-03 assignments](assignment-baseline.md) · [CO-04 role catalog](role-catalog-baseline.md) · [CO-05 command policy](company-policy-baseline.md) · [CO-06 artifact/evidence](artifact-evidence-baseline.md) · [CO-07 receipts](company-receipts-baseline.md) · [CO-08 replay](company-replay-baseline.md) · [组织、业务流程与交付闭环](companyos.md) |
