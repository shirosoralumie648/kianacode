...
| 专项 | 局部索引 | 位置 |
|---|---:|---|
| ControlPlane | CP-00–CP-30（31） | [P0-A-01b schema registry](schema-registry-baseline.md) · [P0-A-02 error codes](error-codes-baseline.md) · [P0-K1-01 身份与 authority epoch](identity-authority-baseline.md) · [P1-E-01 communication](communication-baseline.md) · [CP-01 身份基线](control-plane-identity-baseline.md) · [CP-02 执行身份基线](control-plane-execution-identity-baseline.md) · [CP-03 action 基线](control-plane-action-baseline.md) · [CP-04 ScopeSet 基线](control-plane-scope-baseline.md) · [CP-05 入口一致性](control-plane-entry-path-baseline.md) · [CP-06 原子转移基线](control-plane-transition-baseline.md) · [授权、状态转移与恢复设计](control-plane.md) |
...
| 配置 / 凭据 / 身份 | CI-01–CI-12（12） | [CI-02 identity contracts](identity-contracts-baseline.md) · [CI-03 ports](ports-identity-baseline.md) · [CI-04 daemon ingress](daemon-ingress-baseline.md) · [roadmap §29](../roadmap.md#config-credentials-identity-plan) |
