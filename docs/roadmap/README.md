...
| UI / Entrypoints | UI-00–UI-41（42） | [UI-01 protocol DTO](ui-protocol-baseline.md) · [UI-02 handshake](ui-handshake-baseline.md) · [CLI、Workbench、Web、Desktop 与入口一致性](ui-entrypoints.md) |
