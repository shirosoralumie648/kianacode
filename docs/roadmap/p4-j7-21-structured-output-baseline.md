...
```text
source_snapshot: master 39a43b4b plus P4-J7-21 structured-output slice
...
status change: P4-J7-21 source and CI wiring added; roadmap row/card remain 🔄 pending CI
