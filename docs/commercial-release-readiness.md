...
- Add signed plugin receipts plus administrator marketplace allow/deny policy; install receipts now cover local auditability, but they are not yet an enterprise trust policy.
