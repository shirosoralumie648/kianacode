...
- `kiana context index --json` and `kiana context search <query> --json` now provide deterministic local repository indexing and ranked lexical search as the first knowledge/RAG foundation without external services.
