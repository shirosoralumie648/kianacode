...
pub use kiana_domain::{
    ...
    CatalogEntryKind, CellId, CellLifecycle, CellSpec, ClosingReceipt, ComponentId, DelegationId,
    ...
    HOOK_DESCRIPTOR_SCHEMA, HOOK_MANIFEST_SCHEMA, INVOCATION_IDENTITY_SCHEMA, MEMORY_SCOPE_SCHEMA,
