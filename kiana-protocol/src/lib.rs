...
pub use kiana_domain::{
    ...
    MemoryAclDecision, MemoryAclRequest, MemoryModelWriteGate, MemoryScope, MemoryTemporalOmission,
    MemoryTemporalRecord, MemoryTemporalSelection, MemoryTemporalStatus, MemoryVisibility,
    ...
    MEMORY_ACL_REQUEST_SCHEMA, MEMORY_MODEL_WRITE_GATE_SCHEMA, MEMORY_SCOPE_SCHEMA,
