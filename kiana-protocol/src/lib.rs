...
pub use kiana_domain::{
    ...
    AuthenticatedPrincipalRef, AuthoritySnapshot, BudgetLease, BudgetLeaseId, CapabilityErrorCode,
    ...
    CompanyScopeRegistry, ComponentId, ConfigSnapshot, Criterion, CriterionId, DecisionActorKind,
    DecisionOption, DecisionPurpose, DelegationId, DelegationPacket, DepartmentCatalog,
    DispatchIntent, DispatchIntentStatus, EntryPointKind, EntryPointParitySnapshot, EventKindSpec,
    ...
    COMPANY_DISPATCH_INTENT_SCHEMA, CONFIG_SNAPSHOT_SCHEMA, DEPARTMENT_CATALOG_SCHEMA,
