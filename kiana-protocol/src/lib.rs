...
pub use kiana_domain::{
    ...
    ExtensionSnapshotState, ExtensionType, FenceTokenId, Freshness, GoldenContextCase,
    ...
    EXTENSION_SOURCE_RESOLUTION_SCHEMA, GOLDEN_CONTEXT_CASE_SCHEMA, GOLDEN_CONTEXT_FIXTURE_SCHEMA,
