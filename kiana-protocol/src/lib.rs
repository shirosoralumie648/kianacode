...
pub use kiana_domain::{
    ...
    ContextMaterialClass, ContextMaterialType, ContextPlan, ContextPlanItem, ContextResumeView,
    ContextSourceBudget, CredentialDisplayStatus, Criterion, CriterionId, DataBoundary,
    DataBoundaryId, DecisionActorKind, DecisionOption, DecisionPurpose, DelegationId,
    ...
    ExecutionId, ExecutionOutputBudget, ExecutionOutputRef, ExecutionReceipt, ExecutionScope,
    ExecutionStatus, ExtensionCatalog, ExtensionEffect, ExtensionError, ExtensionErrorCode,
    ExtensionExecutionScope, ExtensionId, ExtensionManifest, ExtensionNetworkPolicy,
    ExtensionPackage, ExtensionRequires, ExtensionSignature, ExtensionSnapshot,
    ExtensionSnapshotState, ExtensionType, FenceTokenId, Freshness, GoldenTrace, GoldenTraceId,
    GrantId, HarnessContextStrategy, HarnessEvalComparison, HarnessEvalMetric,
    HarnessEvalMetricObservation, HarnessEvalMetricSet, HarnessEvalMetricStatus,
    ...
    LegacyWireKind, LlmTextMetadata, Membership, MembershipId, MembershipStatus, MemoryAccessPath,
    MemoryAclDecision, MemoryAclRequest, MemoryEvidenceQuote, MemoryExtractionRequest,
    MemoryModelWriteGate, MemoryScope, MemoryTemporalOmission, MemoryTemporalRecord,
    MemoryTemporalSelection, MemoryTemporalStatus, MemoryVisibility, MergeDecisionId, MergeReceipt,
    Message, MessageId, MessageKind, ModelAttemptId, ModelAttemptIdentity, ModelContent,
    ModelOutcome, ModelSideEffectState, ModelStopReason, NormalizedText, Notification,
    NotificationChannel, NotificationEventClass, NotificationEventSource, NotificationEventSpec,
    NotificationId, NotificationStatus, OperationId, OrganizationBinding, OrganizationId,
    OutputContract, OutputValueType, Partition, PartitionId, PartitionProjection, PartitionStatus,
    ...
    ProjectIdentity, ProjectTrustSnapshot, ProjectionCheckpoint, ProviderAccount,
    ProviderAccountId, ProviderAccountStatus, ProviderConfigSnapshot, ProviderConfigSource,
    ProviderContinuation, ProviderProfileSnapshot, ProviderSelectionMode, Purpose, QualityArtifact,
    QualityArtifactId, QualityArtifactStatus, QualityStateTransition, QualityTransitionId,
    QueueEntryId, ReceiptAggregation, ReceiptId, RecoveryResourceSnapshot, RepoMapDependencyEdge,
    RepoMapEvidenceLevel, RepoMapSymbol, RepoMapTaskCandidate, RepoMapTaskSelection, RequestId,
    ResolvedAssignment, ResolvedStepContext, ResourceCleanupPlan, ResourceCleanupReport,
    ResourceLease, ResourceRetention, RetrievalCandidate, RetrievalEvidence, RetrievalHealth,
    RetrievalHealthStatus, RetrievalHit, RetrievalItem, RetrievalPack, RetrievalProfile,
    RetrievalRequest, RetrievalResponse, RetrievalResult, RetrievalSourceKind, ReviewPacket,
    ...
    WireBudget, WireBudgetInput, WorkPacket, WorkPacketStatus, WorkspaceBinding, WorkspaceChange,
    ...
    COMPACT_SUMMARY_SCHEMA, COMPANY_COMMAND_POLICY_SCHEMA, COMPANY_COMMAND_RECEIPT_SCHEMA,
    COMPANY_DISPATCH_INTENT_SCHEMA, CONFIG_SNAPSHOT_SCHEMA, CONTEXT_CACHE_BINDING_SCHEMA,
    CONTEXT_CHECKPOINT_SCHEMA, CONTEXT_INVALIDATION_SCHEMA, CONTEXT_PLAN_SCHEMA,
    CONTEXT_RESUME_VIEW_SCHEMA, DATA_BOUNDARY_SCHEMA, DELIVERY_ATTEMPT_SCHEMA,
    DELIVERY_RECEIPT_SCHEMA, DEPARTMENT_CATALOG_SCHEMA, DEPARTMENT_EXECUTING,
    DEPARTMENT_MONITORING, DEPARTMENT_SNAPSHOT_SCHEMA, DEPARTMENT_SPEC_SCHEMA,
    DISPATCH_PERMIT_SCHEMA, DISPATCH_PERMIT_VERSION, EFFECT_OBSERVATION_SCHEMA,
    EFFECT_OBSERVATION_VERSION, EMBEDDING_METADATA_SCHEMA, ENTRYPOINT_PARITY_SCHEMA,
    ENTRYPOINT_PARITY_SCHEMA_VERSION, EVAL_CASE_OBJECT_SCHEMA, EVAL_DATASET_SCHEMA,
    EVAL_SUITE_OBJECT_SCHEMA, EVENT_KIND_SPECS, EVENT_STORE_HEALTH_SCHEMA,
    EVENT_STORE_HEALTH_VERSION, EVIDENCE_REF_SCHEMA, EXECUTION_IDENTITY_SCHEMA_VERSION,
    EXECUTION_OUTPUT_BUDGET_SCHEMA, EXECUTION_OUTPUT_REF_SCHEMA, EXECUTION_RECEIPT_SCHEMA,
    EXECUTION_SCOPE_SCHEMA, EXECUTION_SCOPE_SCHEMA_VERSION, EXTENSION_CATALOG_SCHEMA,
    EXTENSION_ERROR_SCHEMA, EXTENSION_MANAGE_OPERATION, EXTENSION_MANIFEST_SCHEMA,
    EXTENSION_PACKAGE_SCHEMA, EXTENSION_SNAPSHOT_CACHE_ENTRY_SCHEMA,
    EXTENSION_SNAPSHOT_CACHE_KEY_SCHEMA, EXTENSION_SNAPSHOT_SCHEMA,
    EXTENSION_SOURCE_RESOLUTION_SCHEMA, GOLDEN_TRACE_SCHEMA, HARNESS_EVAL_COMPARISON_SCHEMA,
    HARNESS_EVAL_SCHEMA_VERSION, HARNESS_METRIC_SET_SCHEMA, HARNESS_REPLAY_REPORT_SCHEMA,
    HARNESS_TRACE_BINDING_SCHEMA, HOOK_DECISION_SCHEMA, HOOK_DESCRIPTOR_SCHEMA,
    ...
    INDEX_INVALIDATION_VERSION, INDEX_MANIFEST_SCHEMA, INVOCATION_IDENTITY_SCHEMA,
    LEGACY_CHECKPOINT_DECISION_SCHEMA, LEGACY_COMPATIBILITY_SCHEMA, LEGACY_COMPATIBILITY_VERSION,
    LLM_TEXT_METADATA_SCHEMA, MEMBERSHIP_SCHEMA, MEMORY_ACL_DECISION_SCHEMA,
    MEMORY_ACL_REQUEST_SCHEMA, MEMORY_EXTRACTION_REQUEST_SCHEMA, MEMORY_MODEL_WRITE_GATE_SCHEMA,
    MEMORY_SCOPE_SCHEMA, MEMORY_TEMPORAL_SCHEMA, MERGE_RECEIPT_PATH, MESSAGE_SCHEMA,
    MODEL_ATTEMPT_IDENTITY_SCHEMA, MODEL_CONTENT_SCHEMA, MODEL_OUTCOME_SCHEMA,
    NORMALIZED_TEXT_SCHEMA, NOTIFICATION_EVENT_REGISTRY_SCHEMA, NOTIFICATION_SCHEMA,
    OUTPUT_CONTRACT_SCHEMA, PLUGIN_LIFECYCLE_SCHEMA, PLUGIN_MANIFEST_SCHEMA, POLICY_PROFILE_SCHEMA,
    ...
    PROJECTION_CHECKPOINT_VERSION, PROJECT_ASSIGNMENT_SCHEMA, PROJECT_IDENTITY_SCHEMA,
    PROJECT_TRUST_SNAPSHOT_SCHEMA, PROVIDER_ACCOUNT_SCHEMA, PROVIDER_CONFIG_SNAPSHOT_SCHEMA,
    PROVIDER_CONTINUATION_SCHEMA, PROVIDER_PROFILE_SNAPSHOT_SCHEMA, QUALITY_ARTIFACT_SCHEMA,
    QUALITY_TRANSITION_SCHEMA, RECEIPT_AGGREGATION_SCHEMA, RECEIPT_AGGREGATION_VERSION,
    RECEIPT_CONTRACT_VERSION, RECOVERY_RESOURCE_SNAPSHOT_SCHEMA,
    RECOVERY_RESOURCE_SNAPSHOT_VERSION, REPO_MAP_DEPENDENCY_SCHEMA, REPO_MAP_SYMBOL_SCHEMA,
    REPO_MAP_TASK_SELECTION_SCHEMA, REQUEST_BUDGET_VERSION, RESOLVED_ASSIGNMENT_SCHEMA,
    RESOLVED_STEP_CONTEXT_SCHEMA, RESOURCE_CLEANUP_PLAN_SCHEMA, RESOURCE_CLEANUP_REPORT_SCHEMA,
    ...
    UNIFIED_RETRIEVAL_VERSION, WIRE_BUDGET_SCHEMA, WORKSPACE_FILE_SNAPSHOT_SCHEMA,
