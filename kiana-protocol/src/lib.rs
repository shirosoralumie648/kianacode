...
pub use kiana_domain::{
    ...
    EventKindSpec, EvidenceStatus, ExecutionId, ExecutionScope, ExecutionStatus, Freshness,
    InvocationId, InvocationIdentity, MemoryScope, MergeReceipt, ModelAttemptId,
    ModelAttemptIdentity, ModelContent, ModelOutcome, ModelSideEffectState, ModelStopReason,
    OrganizationId, PermissionProfile, ProjectIdentity, ProviderContinuation, Purpose, ReceiptId,
    RequestId, ReviewPacket, RiskLevel, RoleSpec, RunId, RuntimeEvent, SessionAssignment,
    SessionId, SignalStatus, SourceKind, SourceRef, SourceSnapshot, SpawnPlan, SpawnPlanId, StepId,
    ...
    EXECUTION_SCOPE_SCHEMA_VERSION, INVOCATION_IDENTITY_SCHEMA, MEMORY_SCOPE_SCHEMA,
    MERGE_RECEIPT_PATH, MODEL_ATTEMPT_IDENTITY_SCHEMA, MODEL_CONTENT_SCHEMA, MODEL_OUTCOME_SCHEMA,
    PROJECT_IDENTITY_SCHEMA, PROVIDER_CONTINUATION_SCHEMA, REVIEW_PACKET_SCHEMA, ROLE_ARCHITECT,
    ROLE_BUILDER, ROLE_CLOSER, ROLE_PM, ROLE_REVIEWER, RUNTIME_EVENT_SCHEMA, SCOPE_SET_SCHEMA,
    SCOPE_SET_SCHEMA_VERSION, SESSION_ASSIGNMENT_SCHEMA, SOURCE_REF_SCHEMA, SOURCE_SNAPSHOT_SCHEMA,
