...
pub use kiana_domain::{
    ...
    ProviderSelectionMode, Purpose, QueueEntryId, ReceiptId, RequestId, ResolvedAssignment,
    ReviewPacket, RiskLevel, RoleAssignment, RoleAssignmentStatus, RoleCatalog, RoleDescriptor,
    RoleSpec, RunId, RuntimeEvent, SecretRef, ServiceIdentity, ServiceIdentityId,
    ...
    SERVICE_IDENTITY_SCHEMA, SESSION_ASSIGNMENT_SCHEMA, SHARING_GRANT_SCHEMA,
