...
pub use kiana_domain::{
    ...
    TemplateId, ToolSpec, TurnId, TurnIdentity, TurnOutcome, TurnOutcomeInput, TurnOutcomeKind,
    TurnSemantics, WorkPacket, WorkPacketStatus, WorkspaceBinding, WorkspaceId, ACTION_REF_SCHEMA,
