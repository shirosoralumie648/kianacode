...
pub use kiana_domain::{
    ...
    AuthenticationAssurance, AuthorityLedger, AuthoritySnapshot, BudgetLease, BudgetLeaseId,
    CapabilityErrorCode, CapabilityErrorPolicy, CapabilityExecutionState, CapabilityGrant,
    CapabilityGrantId, CapabilityProcessState, CapabilityResultDimensions, CatalogCandidate,
    CatalogEntry, CatalogEntryKind, CellId, CellLifecycle, CellSpec, ChildCellId, ClosingReceipt,
    ...
    GoldenTrace, GoldenTraceId, GrantId, HookDecision, HookDecisionKind, HookDescriptor,
    ...
    AUTHENTICATED_PRINCIPAL_SCHEMA, AUTHORITY_LEDGER_SCHEMA, AUTHORITY_SNAPSHOT_SCHEMA,
