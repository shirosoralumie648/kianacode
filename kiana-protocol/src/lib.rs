...
pub use kiana_domain::{
    ...
    EffectObservation, EffectObservationState, EmbeddingMetadata, EntryPointKind,
    EntryPointParitySnapshot, EvalCase, EvalCaseId, EvalDataset, EvalDatasetId, EvalSplit,
    EvalSuite, EvalSuiteId, EvalSuiteStatus, EventKindSpec, EventStoreHealth, EvidenceId,
    EvidenceRef, EvidenceRefId, EvidenceStatus, ExecutionId, ExecutionOutputBudget,
    ExecutionOutputRef, ExecutionReceipt, ExecutionScope, ExecutionStatus, ExtensionCatalog,
