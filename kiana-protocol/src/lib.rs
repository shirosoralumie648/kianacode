...
pub use kiana_domain::{
    ...
    ConfigSnapshot, ContextCandidate, ContextCheckpoint, ContextCheckpointState,
    ContextMaterialClass, ContextMaterialType, ContextPlan, ContextPlanItem, ContextSourceBudget,
    ...
    EmbeddingMetadata, EntryPointKind, EntryPointParitySnapshot, EvalCase, EvalCaseId, EvalDataset,
    EvalDatasetId, EvalSplit, EvalSuite, EvalSuiteId, EvalSuiteStatus, EventKindSpec,
    ...
    COMPANY_DISPATCH_INTENT_SCHEMA, CONFIG_SNAPSHOT_SCHEMA, CONTEXT_CHECKPOINT_SCHEMA,
