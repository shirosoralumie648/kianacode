...
pub use kiana_domain::{
    ...
    HarnessReplayMode, HarnessReplayReport, HarnessTraceBinding, HistoricalReceiptInvalidation,
    HookBudget, HookDecision, HookDecisionKind, HookDescriptor, HookExecutionRole,
    HookFailurePolicy, HookLifecycleBinding, HookLifecycleInput, HookLifecyclePlan,
    HookLifecyclePoint, HookLifecycleResult, HookOrderCandidate, HookPhase, HookRunId,
    HumanDecision, HumanTask, HumanTaskStatus, IdentityMigration, IndexCacheKey,
    ...
    HARNESS_TRACE_BINDING_SCHEMA, HISTORICAL_RECEIPT_INVALIDATION_SCHEMA, HOOK_DECISION_SCHEMA,
    ...
    LEGACY_COMPATIBILITY_VERSION, LLM_TEXT_METADATA_SCHEMA, MEMBERSHIP_SCHEMA,
    MEMORY_ACL_DECISION_SCHEMA, MEMORY_ACL_REQUEST_SCHEMA, MEMORY_DISTILLATION_SOURCE_SCHEMA,
    MEMORY_EXTRACTION_REQUEST_SCHEMA, MEMORY_INVALIDATION_SCHEMA, MEMORY_MODEL_WRITE_GATE_SCHEMA,
