...
These Agent Discretion questions were resolved by the checked Phase 1 plan contract. They are implementation choices, not new user requirements. [VERIFIED: .planning/phases/01-baseline-evidence-governance/01-CONTEXT.md Agent Discretion]

1. **Canonical layout - RESOLVED:** use immutable revision files under separate snapshot directories for public baseline, repository registry, capability decisions, and evidence. A closed path/hash-only `current.json` selects explicit heads but stores no completion fields. Plans: `01-01`, `01-02`, `01-08`, `01-09`, `01-10`. [VERIFIED: .planning/phases/01-baseline-evidence-governance/01-01-PLAN.md; .planning/phases/01-baseline-evidence-governance/01-02-PLAN.md; .planning/phases/01-baseline-evidence-governance/01-08-PLAN.md; .planning/phases/01-baseline-evidence-governance/01-09-PLAN.md; .planning/phases/01-baseline-evidence-governance/01-10-PLAN.md]
2. **Compiler split - RESOLVED:** place all proof, ancestry, fingerprint, validation, escaping, and deterministic rendering primitives in `scripts/capability_governance.py`; expose thin validator, freeze/refresh, and generator CLIs without duplicating semantics. Plans: `01-06`, `01-07`, `01-11`. [VERIFIED: .planning/phases/01-baseline-evidence-governance/01-06-PLAN.md; .planning/phases/01-baseline-evidence-governance/01-07-PLAN.md; .planning/phases/01-baseline-evidence-governance/01-11-PLAN.md]
3. **Product adapter - RESOLVED:** Phase 1 adds no Rust `audit/report` adapter. Checked-in generated views plus the focused offline production gate satisfy the phase success criteria; any later product-surface adapter must consume the same validated contract. Plan: `01-11`. [VERIFIED: .planning/phases/01-baseline-evidence-governance/01-11-PLAN.md]
4. **Official-source retention - RESOLVED:** retain a controlled normalized public-source artifact with official URI, immutable archive URI, retrieval/product metadata, whole-content and per-entry SHA-256, plus an offline identity fixture. The Phase 1 CLIs do not fetch the network or store non-public material. Plans: `01-01`, `01-03`, `01-07`, `01-08`. [VERIFIED: .planning/phases/01-baseline-evidence-governance/01-01-PLAN.md; .planning/phases/01-baseline-evidence-governance/01-03-PLAN.md; .planning/phases/01-baseline-evidence-governance/01-07-PLAN.md; .planning/phases/01-baseline-evidence-governance/01-08-PLAN.md]
5. **Content-only revision identity - RESOLVED:** compute deterministic normalized tree SHA-256, record `revision_kind=content_tree_sha256`, and keep the stable repository ID independent from revision identity. Plans: `01-01`, `01-03`, `01-05`, `01-06`, `01-09`. [VERIFIED: .planning/phases/01-baseline-evidence-governance/01-01-PLAN.md; .planning/phases/01-baseline-evidence-governance/01-03-PLAN.md; .planning/phases/01-baseline-evidence-governance/01-05-PLAN.md; .planning/phases/01-baseline-evidence-governance/01-06-PLAN.md; .planning/phases/01-baseline-evidence-governance/01-09-PLAN.md]
6. **Legacy authority migration - RESOLVED:** classify every exact status-bearing path as `generated_projection`, `frozen_migration_input`, or `narrative_no_status`, bind its hash/rationale/replacement view in canonical data, and generate a replacement index plus directory warning. Existing dirty legacy files remain untouched. Plans: `01-02`, `01-10`, `01-11`. [VERIFIED: .planning/phases/01-baseline-evidence-governance/01-02-PLAN.md; .planning/phases/01-baseline-evidence-governance/01-10-PLAN.md; .planning/phases/01-baseline-evidence-governance/01-11-PLAN.md]
