...
**Defined:** 2026-07-15
**Recut:** 2026-08-22 — current v1 requirements are the v0.2 runnable local agent MVP. The original 104-item 1.0 ledger is parked in the appendix and is not this milestone's execution scope.
...
### Parked 1.0 product scope

Original 104 v1.0 requirements (CORE/COD/RES/DAY/SURF/CLOUD/ENT/DIF/NFR) are **not** this milestone. They remain the north star and are copied in Appendix A.

### Post-1.0 Extensions

POST-01 至 POST-12 仍明确推迟到 1.0 之后，见 Appendix B。
...
# Appendix A: Parked v1.0 North Star Requirements

> Preserved from the 2026-07-15 / 2026-07-26 104-req ledger. This is **not** v0.2 execution scope. Do not mark these complete because a crate, command, or test exists.
...
- Original POST-01..POST-12 remain inside Appendix A as they were in the 1.0 ledger.
- Original traceability that mapped CORE/COD/RES/DAY/SURF/CLOUD/ENT/DIF/NFR onto phases 3–24 is historical only.
- Live traceability for execution is the table in the current-milestone section above.
