...
cp scripts/install-release-binary.sh scripts/package-lifecycle-smoke.sh scripts/product-shell-smoke.sh scripts/provider-live-smoke.sh scripts/remote-live-smoke.sh scripts/sign-release-artifacts.sh scripts/verify-commercial-release-artifacts.sh "$stage/scripts/"
